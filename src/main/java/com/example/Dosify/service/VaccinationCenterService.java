...
public interface VaccinationCenterService {
    ...
    List<DoctorResponseDto> DoctorsatCentre(int id) throws Exception;

    List<DoctorResponseDto> maledocatcenter(int id) throws Exception;
...
//    table.columnNames=Emp Id,Emp Name,Emp Dept,Emp Sal
    List<DoctorResponseDto> femaledocatcenter(int id) throws Exception;

    List<DoctorResponseDto> maledocatcenterabovex(int id) throws Exception;
